...
class youtube_sub_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'youtube_sub_Widget', // Base ID
			esc_html__( 'Youtube Sub Title', 'yts_dommain' ), // Name
			array( 'description' => esc_html__( 'A  Widget to display youtube subscriber', 'yts_dommain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo $args['after_widget'];// whatever you want to display before widget
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Youtube Subscription', 'yts_domain' );
